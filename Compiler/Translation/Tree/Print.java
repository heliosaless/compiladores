...
public class Print {
  ...
  Translation.Temp.TempMap tmap;

  public Print(java.io.PrintStream o, Translation.Temp.TempMap t) {out=o; tmap=t;}

  public Print(java.io.PrintStream o) {out=o; tmap=new Translation.Temp.DefaultMap();}
